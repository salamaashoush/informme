        ...
        <div class="box-body" id="citiesdiv">
            @if(isset($cities)&&$cities->count()>0)
                @foreach($cities as $city)
                    @foreach($city->units()->get()->chunk(4) as $chunk)
                    <div class="row">
                            ...
                            <div class="col-sm-4 col-lg-3">
                                <div class="box box-widget widget-user">
                                    <div class="box box-widget widget-user">
                                        ...
                                        <div class="widget-user-header bg-yellow "style=" background: url('{{asset($unit->photos()->where('name','=',$unit->name."_flag")->first()['path'])}}') center center;">
                                            <!-- /.widget-user-image -->
                                        ...
                                        <div class="box-footer no-padding">
                                            <ul class="nav nav-stacked">
                                                <li><a href="#">City <span class="pull-right badge bg-blue">{{$unit->city['name']}}</span></a></li>
                                                <li><a href="#">Governorate <span class="pull-right badge bg-red">{{$unit->city->governorate['name']}}</span></a></li>
                                                <li><a href="#">Area <span class="pull-right badge bg-red">{{$unit->area}}</span></a></li>
                                            </ul>
                                            <a href="{{route('divisions.show',$unit->id)}}" class="btn btn-info btn-block">view Details</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
